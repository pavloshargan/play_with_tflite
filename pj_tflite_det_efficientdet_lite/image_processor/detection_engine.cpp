...
/* Model parameters */
#define MODEL_NAME  "lite-model_efficientdet_lite0_detection_metadata_1.tflite"
...
#define IS_RGB      true
#define OUTPUT_NAME_0 "StatefulPartitionedCall:0"   /* The number of the detected boxes. */
#define OUTPUT_NAME_1 "StatefulPartitionedCall:1"   /* The scores of the detected boxes. */
#define OUTPUT_NAME_2 "StatefulPartitionedCall:2"   /* The categories of the detected boxes. */
#define OUTPUT_NAME_3 "StatefulPartitionedCall:3"   /* The locations of the detected boxes. */
...
int32_t DetectionEngine::Process(const cv::Mat& original_mat, Result& result)
{
    ...
    float* num_raw_list = output_tensor_info_list_[0].GetDataAsFloat();
    float* score_raw_list = output_tensor_info_list_[1].GetDataAsFloat();
    float* label_raw_list = output_tensor_info_list_[2].GetDataAsFloat();
    float* bbox_raw_list = output_tensor_info_list_[3].GetDataAsFloat();
