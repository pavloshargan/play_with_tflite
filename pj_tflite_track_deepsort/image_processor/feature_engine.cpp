...
#define MODEL_NAME  "deepsort_128x64.tflite"
#define TENSORTYPE  TensorInfo::kTensorTypeFp32
#define INPUT_NAME  "input_1"
#define INPUT_DIMS  { 1, 128, 64, 3 }
#define IS_NCHW     false
#define IS_RGB      true
#define OUTPUT_NAME "Identity"
#elif defined(MODEL_TYPE_ONNX)
#define MODEL_NAME  "deepsort_128x64.onnx"
#define TENSORTYPE  TensorInfo::kTensorTypeFp32
#define INPUT_NAME  "input.1"
#define INPUT_DIMS  { 1, 3, 128, 64 }
#define IS_NCHW     true
#define IS_RGB      true
#define OUTPUT_NAME "209"
#endif

static constexpr int32_t kNumFeature = 512;
